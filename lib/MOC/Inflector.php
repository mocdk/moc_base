 ...
 *					   MOC_Inflector::rules('plural', array('/^(inflect)or$/i' => '\1ables'));
 *					   MOC_Inflector::rules('plural', array(
 ...
 */
	public static function tableize($className) {
		if (!isset(self::$_tableize[$className])) {
			self::$_tableize[$className] = MOC_Inflector::pluralize(MOC_Inflector::underscore($className));
		}
 ...
 */
	public static function variable($string) {
		if (!isset(self::$_variable[$string])) {
			$string = MOC_Inflector::camelize(MOC_Inflector::underscore($string));
